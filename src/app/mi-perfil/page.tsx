...
export default function MyProfile() {
  ...
  const [varPopUpWarning, setVarPopUpWarning] = useState({
    image: checkImage,
    text: "",
  });
  ...
  return (
    <>
      <PopUp
        isOpen={showPopUp}
        message="¿Deseas eliminar tu cuenta?"
        isTwoButtons={true}
        btnOneText="ELIMINAR"
        btnTwoText="CANCELAR"
        handleClickPrimary={handleDeleteAccount}
      ...
      <Container sx={{ mt: "25px !important" }}>
        ...
        {showFormShow ? (
          <FormShow
            ...
            handleClickDelete={showPopUpConfirmDelete}
            handleClickEdit={chageFormShow}
          />
        ) : (
