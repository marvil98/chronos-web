...
export function FormEdit({ handleClickSaveEdit }: FormEditProps) {
  ...
  const validateForm = (name: string, value: string) => {
    ...
    setInputs((prevState) => ({
      ...
      [name]: {
        value: value,
        error: hasError,
        message: hasError ? "Este campo es requerido" : "",
      },
    }));
        ...
        case "input3":
          ...
          setInputs((prevState) => ({
            ...
            [name]: {
              value: value,
              error: hasError,
              message: hasError ? "Este debe ser un número" : "",
            },
          }));
          break;
        case "input4":
          ...
          setInputs((prevState) => ({
            ...
            [name]: {
              value: value,
              error: hasError,
              message: hasError ? "El correo es invalido" : "",
            },
          }));
          break;
        case "input5":
          ...
          setInputs((prevState) => ({
            ...
            [name]: {
              value: value,
              error: hasError,
              message: hasError ? "Las contraseñas deben ser iguales" : "",
            },
          }));
          if (hasError) {
  ...
  const areAllFieldsCorrect = () => {
    let validError = Object.values(inputs).every(
      (input) => input.error === false,
    );
    let validValues = Object.values(inputs).every(
      (input) => input.value !== "",
    );
